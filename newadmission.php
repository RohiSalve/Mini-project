            ...
            <tr>
             ...
             <tr>
                <th>Physically Challenged? </th>
                 <td class="f1"><input type="radio" name="physicallychallenged">Yes </td>
                 <td class="f1"><input type="radio" name="physicallychallenged">No </td>
             ...
             <tr>
                <th>Phone </th>
                 ...
                 <th>Telephone </th>
                 <td><input class="e1" type="tel" placeholder="Enter telephone no."maxlength="10" name="telephone"></td>
             </tr>
             <tr>
                <th>Email </th>
             ...
             <tr>
                ...
                <td><input class="e1" type="uid" placeholder="Enter Student's Aadhar Card Number" maxlength="12"  name="adharcard"></td>
               <td> <a href="Admission_form.htm" class="btn btn-lg btn-primary eee"><input type="submit" name="insert" value="Submit"/></a></td>
           <!-- </tr>
            <tr>
